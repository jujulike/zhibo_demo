...
<h4 class="marginbot">
	内容管理 >> 地区级管理
		...
		<div class="mainbox">
			...
			<lable>地区四级管理</lable>&nbsp;<input type="text" name="name" id="name" />&nbsp;<a href="javascript:submitAdd()" class="sgbtn" >添加</a>
			</form>
            <div class="provincelist">
				...
				<dt style="width:220px">
					<span style="float:left;color:#2366A8;font-size:14px"><?php echo $item['name']?></span>
...
function submitAdd()
{
	postdata('regionForm', "<?php echo site_url('admin/region/add/'.$parentid.'/3');?>", 'show');
}
