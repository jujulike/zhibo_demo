...
<div class="so_main">
  ...
  <div class="Toolbar_inbox">
	...
	<a  class="btn_a"  onclick="openreg()"><span>添加会员</span></a>
	<a  class="btn_a"  onclick="openmulreg()"><span>批量添加会员</span></a>
  </div>
  <div class="list">
...
function openmulreg()
{
	$.jBox.open('iframe:<?php echo site_url("admin/user/muladd");?>', "用户添加", 500, 420, { buttons: { '关闭': true} });
}
