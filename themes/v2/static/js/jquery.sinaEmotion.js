...
$(function() {
	...
	$.ajax( {
		...
		success : function(response) {
			...
			uSinaEmotionsHt.put('[pt顶一个]', '/images/1.gif');
            uSinaEmotionsHt.put('[pt赞一个]', '/images/2.gif');
            uSinaEmotionsHt.put('[pt掌声]', '/images/3.gif');
            uSinaEmotionsHt.put('[pt鲜花]', '/images/4.gif');
            uSinaEmotionsHt.put('[pt看多]', '/images/5.gif');
            uSinaEmotionsHt.put('[pt看空]', '/images/6.gif');
            uSinaEmotionsHt.put('[pt震荡]', '/images/7.gif');
		}
	});
});
...
(function($){
	$.fn.SinaEmotion = function(target){
		...
		$(this).click(function(event){
			...
			var eTop = target.offset().top + target.height() - 391;
