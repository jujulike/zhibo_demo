<div id="head" class="cfix">
    <div class="head_bg1"><a class="logo" href="<?php echo site_url("home") ?>"><img src="<?php if (!empty($cfg['imgthumb'])) echo base_url($cfg['imgthumb']); ?>" width="167" height="40" /></a></div>
<div class="room-title">				

			<span class="link-split"><!--分隔线--></span>
			  <div class="kshow_cjsj" id="pingtaijieshao" onclick="tuankuang(this.id);">期货资讯</div>

				<span class="link-split"><!--分隔线--></span>
				<div class="kshow_cjsj" id="jiabinjieshao" onclick="tuankuang(this.id);">嘉宾介绍</div>

				<span class="link-split"><!--分隔线--></span>
				<div class="kshow_cjsj" id="jiabinjieshao" onclick="window.open('http://futures.eastmoney.com/')">期货快讯</div>

				<span class="link-split"><!--分隔线--></span>
				<div class="kshow_cjsj" id="jiabinjieshao" onclick="window.open('http://www.lcqs.net/')">论坛</div>

			   <span class="link-split"><!--分隔线--></span>
			  <div class="kshow_cjsj" id="kechengbiao" onclick="tuankuang(this.id);"><img src="<?php echo base_url($cfg['tpl'])?>/images/zb_4.png" tppabs="<?php echo base_url($cfg['tpl'])?>/images/zb_4.png" style="margin: 1px auto" title="课程表"></div>
			   <span class="link-split"><!--分隔线--></span>
			  <div class="kshow_cjsj" id="handantixing" onclick=" notice('仅VIP会员具备查询权限，请联系官方客服开通。') "><img src="<?php echo base_url($cfg['tpl'])?>/images/zb_1.png" tppabs="<?php echo base_url($cfg['tpl'])?>/images/zb_1.png" style="margin: 2px auto" title="喊单提醒"></div>
			  	<span class="link-split"><!--分隔线--></span>
			  <div class="kshow_cjsj" id="caijingshuju" onclick="tuankuang(this.id);"><img src="<?php echo base_url($cfg['tpl'])?>/images/zb_t2.png" tppabs="<?php echo base_url($cfg['tpl'])?>/images/zb_t2.png" style="margin: 2px auto" title="财经数据"></div>
			  		<span class="link-split"><!--分隔线--></span>
			  <div class="kshow_cjsj" id="caijingrili" onclick="tuankuang(this.id);"><img src="<?php echo base_url($cfg['tpl'])?>/images/zb_t4.png" tppabs="<?php echo base_url($cfg['tpl'])?>/images/zb_t4.png" style="margin: 2px auto" title="财经日历"></div>
    ...
    <div id="rightMenu" class="cfix fr">
      ...
      <div class="fl cfix" style="padding:5px 0 0 15px">
 			<span><a href="javascript:void(0)" onclick="getabout()"><img src="<?php echo base_url($cfg['tpl'])?>/images/head_icon2.png"   />产品介绍</a></span>
  ...
  <script type="text/javascript">
	...
	function getabout(){
		var ii = $.layer({
				...
				title: '产品介绍',
				area: ['1300px', '600px'],
				iframe: {src: 'http://www.pintaipme.com/dyy/index.html',scrolling: 'yes'}
			});
	}
