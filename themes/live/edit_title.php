...
<div class="login clearfix">
			...
			<INPUT TYPE="hidden" NAME="userid" value="<?php echo $masterinfo['userid'];?>">
			<INPUT TYPE="hidden" NAME="roomid" value="<?php echo $masterinfo['roomid'];?>">
			<INPUT TYPE="hidden" NAME="masterid" value="<?php echo $masterinfo['masterid'];?>">
			<INPUT TYPE="hidden" NAME="masterinfo" value="<?php echo $masterinfo['masterinfo'];?>">

			<table border="0" class="box-login">
			<tbody>
			<tr>
					<td width="100" style="text-align:right">直播主题名称(<span class="red">*</span>)：</td>
					<td width="165"><input type="text" name="mastertitle"  class="newtitle" value="<?php echo $masterinfo['mastertitle'] ?>"></td>
			</tr>
			<tr>
				<td style="text-align:right">直播主题简介(<span class="red">*</span>)：</td>
				<td><TEXTAREA NAME="masterinfo" ROWS="4" COLS="" class="newtextarea" ><?php echo $masterinfo['masterinfo']?></TEXTAREA></td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td style="padding-top:15px"><input type="button" onclick="setmaster()" value=" 修 改 " class="login-button">&nbsp;&nbsp;</td>
			</tr>
...
function setmaster()
{
	postdata('regform', '<?php echo site_url("live/editTitle");?>', 'show');
}
</script>
