...
class BayouSmsSender
{
    ...
    var $use_curl                    = false;
	//调用例子，在最下面，仅供参考调用
	public function sendsms($username,$password,$mobiles,$msg)
	{
		$content = urlEncode(urlEncode(mb_convert_encoding($msg, 'gb2312' ,'utf-8')));
		//$content = mb_convert_encoding($msg, 'gb2312' ,'utf-8');
...
//		$apiurl = "http://sms.c8686.com/Api/BayouSmsApiEx.aspx";
		$apiurl = "http://wx360.bjfzq.com/NetMessage/http/SendSMS";
		$apidata="USERNAME=$username&PASSWORD=$password&MOBILE=$mobiles&CONTENT=$content";
...
$result=$sender->sendsms("bjztcf_V2","123456","15057489802",$msg);
var_dump($result);
*/
?>